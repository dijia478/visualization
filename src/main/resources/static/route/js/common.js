...
function initMap(options) {
    ...
    var map = new BMapGL.Map('map_container', {
        ...
        style: {styleJson: options.style || purpleStyle }
    });
    ...
    map.addControl(new BMapGL.ScaleControl()); //默认在地图左下角的比例尺
    return map;
}

function updateLogo() {
    // 修改左下角logo
    var imgElement = document.querySelector('.anchorBL img');
    imgElement.src = '../QR_code.png';
