...
# 软件包名
PACKAGE_NAME=visualization-0.0.1-SNAPSHOT.jar
...
# 日志文件前缀
PROCESS_LOG_PREFIX=visualization

# JVM内存参数
JAVA_OPTS=" -Xms512m -Xmx512m -Xmn256m -Xss256k -XX:PermSize=64m -XX:MaxPermSize=128m "
